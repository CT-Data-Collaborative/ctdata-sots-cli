...
def build_supplemental_tables(conn, cursor):
    ...
    tx_code_data_query = """INSERT INTO tx_codes(cd_trans_type, label, stock. nonstock, domestic, foreign_company, benefit, company_type) VALUES """
